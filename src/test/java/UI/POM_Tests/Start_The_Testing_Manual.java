...
import smk.UI_Automation.ManulOperation;
import smk.UI_Automation.MenuPage;
import smk.UI_Automation.Stop_Continue_Abort_Resume;

public class Start_The_Testing_Manual extends BaseTest {
...
//		String AMRName = "LWB-20";
		...
		while (true) {
			...
			try {
				if (R != 0) {
					Thread.sleep(R);
					mup.waitForWebElementToAppear(mup.Nobtn);
					mup.ClickNo();
				}
			} catch (Exception e) {
			...
			//Frot Manual Operation
			try {
				Thread.sleep(2000);
				mnp.ManulBtn.click();
				mnp.ManulFront.click();
				mnp.ManulFrontBox.sendKeys("2000");
				mnp.ManulGo.click();
				mnp.waitForWebElementToAppear(mnp.AutoWBtn);
				mnp.AutoWBtn.click();
				mnp.waitForWebElementToAppear(mnp.ManulBtn);
				mup.SelectWorkFlow(workflowName);
				
			}catch(Exception e)
			{
			    System.out.println("Front not went");
				
			}
			
			//Clock Manual Operation
			try {
				Thread.sleep(2000);
				mnp.ManulBtn.click();
				mnp.ManulClock.click();
				mnp.ManulClockBox.sendKeys("45");
				mnp.ManulGo.click();
				mnp.waitForWebElementToAppear(mnp.AutoWBtn);
				mnp.AutoWBtn.click();
				mnp.waitForWebElementToAppear(mnp.ManulBtn);
			...
			{
			    System.out.println("Clock not went");
			...
			try {
				...
				mnp.ManulBtn.click();
				mnp.ManulBack.click();
				mnp.ManulBackBox.sendKeys("2000");
				mnp.ManulGo.click();
				mnp.waitForWebElementToAppear(mnp.AutoWBtn);
				mnp.AutoWBtn.click();
				mnp.waitForWebElementToAppear(mnp.ManulBtn);
			...
			{
			    System.out.println("Back not went");
			...
			try {
				Thread.sleep(2000);
				mnp.ManulBtn.click();
				mnp.ManulAntiClock.click();
				mnp.ManulAntiClockBox.sendKeys("45");
				mnp.ManulGo.click();
				mnp.waitForWebElementToAppear(mnp.AutoWBtn);
				mnp.AutoWBtn.click();
				mnp.waitForWebElementToAppear(mnp.ManulBtn);
			...
			{
			    System.out.println("AntiClock not went");
